...
Window{
    ...
    Dial {
        ...
        {
            r = dialR.value/255
            led1.color = Qt.rgba(r,g,b)
            rlabel.text = "R Value - "+dialR.value.toFixed(0)
            rgblabel.text = led1.color
        }
    ...
    Dial {
        ...
        onMoved:
        {
            g = dialG.value/255
            led1.color = Qt.rgba(r,g,b)
            glabel.text = "G Value - "+dialG.value.toFixed(0)
            rgblabel.text = led1.color
    ...
    Dial {
        ...
        onMoved:
        {
            b = dialB.value/255
            led1.color = Qt.rgba(r,g,b)
            blabel.text = "B Value - "+dialB.value.toFixed(0)
            rgblabel.text = led1.color
        }
